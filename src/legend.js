      ...
      link: function(scope, elem) {
        ...
        function render() {
          ...
          for (i = 0; i < seriesList.length; i++) {
            ...
            html += "</span>";
            html += '<span class="piechart-legend-alias" style="float:none;">' + seriesData.label + "</span>";
